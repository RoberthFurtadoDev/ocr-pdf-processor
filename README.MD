...
flowchart TD
    ...
    E -->|5. Le mensagem da fila| F[Worker SqsListenerService]
    F -->|6. Atualiza status PROCESSANDO| D
    F -->|7. Pede analise Textract (S3)| C
    F -->|8. Envia arquivo para analise| G[Amazon Textract AI]
    G -->|9. Retorna texto extraido| F
    F -->|10. Salva texto e CONCLUIDO| D

    A -->|11. GET /api/pdf/status/{id}| B
    B -->|12. Consulta status DB| D
```
